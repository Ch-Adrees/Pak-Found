...
class _LostItemFormState extends State<LostItemForm> with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text('Report Lost Item', style: TextStyle(color: Colors.white),),
                            ...
                            Expanded(
                              child: Text(
                                selectedDate != null && selectedTime != null
                                    ? 'Lost on: ${DateFormat.yMMMd().format(selectedDate!)} ${selectedTime!.format(context)}'
                                    : 'Select Date & Time*',
                              ),
                            ),
                            IconButton(
